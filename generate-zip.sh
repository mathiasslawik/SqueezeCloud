...
cd ..
zip -r SqueezeCloud-$VERSION.zip SqueezeCloud -x \*.zip \*.sh \*.git\* \*README\* \*webauth\* \*.sublime\* \*.DS_Store\*
...
<extensions>
	...
	<plugins>
		<plugin name="SqueezeCloud" version="$VERSION" minTarget="7.5" maxTarget="*">
			...
			<url>https://danielvijge.github.io/SqueezeCloud/SqueezeCloud-$VERSION.zip</url>
